      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="bg-white rounded-2xl p-8 mb-6 shadow-sm">
          <div className="flex items-start justify-between">
            ...
            <Button
              ...
              className="bg-[#E4B95C] hover:bg-[#d9a532] text-slate-900 font-normal font-montserrat rounded-full px-6 cursor-pointer"
            >
              Edit profile
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <p className="text-[#666666] text-xl mb-2 font-montserrat">
              Bounties Completed
            </p>
            <div className="flex items-center gap-2">
        ...
        <div className="overflow-hidden">
          <div className="bg-gray-100 p-2 m-4 rounded-full inline-flex w-auto gap-2">
            <button
              ...
              className={`py-2 px-20 font-montserrat font-normal transition-all rounded-full ${
                activeTab === "completed"
                    ...
                    <div className="flex-1 pr-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="text-[#666666] font-montserrat font-semibold">
                            {bounty.progress}%
                          </span>
                        </div>
